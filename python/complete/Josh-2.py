...
class Computer:
    ...
    def minimax(self, positions, winner, maximizingPlayer, MAX_DEPTH, POSITIONAL_SCORE, HORIZONTAL_SPACES, VERTICAL_SPACES):
        ...
        if maximizingPlayer: #Computer's turn (Trying to maximize score)
            ...
            for move in valid_moves:
                ...
                _, evaluation = self.minimax(new_positions, winner, False, MAX_DEPTH-1, POSITIONAL_SCORE, HORIZONTAL_SPACES, VERTICAL_SPACES) 
                if evaluation > value:
                    value = evaluation
                    best_move = move
            ...
            for move in valid_moves:
                ...
                new_positions.update({move:1})
                _, evaluation = self.minimax(new_positions, winner, True, MAX_DEPTH-1, POSITIONAL_SCORE, HORIZONTAL_SPACES, VERTICAL_SPACES)
...
while flag:
    ...
    if AGAINST_AI and flag:
        if turn == -1: 
            ...
            pygame.display.flip()
            best_move, _ = computer.minimax(positions, winner, True, MAX_DEPTH, POSITIONAL_SCORE, HORIZONTAL_SPACES, VERTICAL_SPACES)
